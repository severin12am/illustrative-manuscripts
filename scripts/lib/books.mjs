...
export const PHOTO_FOCUS = {
  ...
  P1: [{ book: 40, chapter: 1, verseStart: 1, verseEnd: 8 }],
  P18: [{ book: 66, chapter: 4, verseStart: 1, verseEnd: 5 }],
  P20: [{ book: 59, chapter: 3, verseStart: 1, verseEnd: 9 }],
  P23: [{ book: 59, chapter: 1, verseStart: 10, verseEnd: 12 }],
  P29: [{ book: 44, chapter: 26, verseStart: 7, verseEnd: 8 }],
  P32: [{ book: 56, chapter: 1, verseStart: 11, verseEnd: 15 }],
  P40: [{ book: 44, chapter: 18, verseStart: 27, verseEnd: 19 }],
  P47: [{ book: 66, chapter: 13, verseStart: 16, verseEnd: 18 }],
